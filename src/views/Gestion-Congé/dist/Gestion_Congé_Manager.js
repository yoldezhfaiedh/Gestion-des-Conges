            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, axios_1["default"].get("http://localhost:5000/demandeconge/EnCours")];
                        case 1:
                            response = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1["default"].post("http://localhost:5000/demandeconge/Accepter/" + _id + "?id=" + _id)];
                case 1:
                    // Effectuez votre appel Axios pour valider la décision
                    _a.sent();
                    updatedDemandes = demandesConge.map(function (demande) {
                        if (demande._id === _id) {
                            return __assign(__assign({}, demande), { statut: 'Acceptée En attente de confirmation' }); // Mettre à jour le statut de la demande
                        }
                        return demande;
                    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    // Effectuez votre appel Axios pour valider la décision
                    return [4 /*yield*/, axios_1["default"].post("http://localhost:5000/demandeconge/Refuser/" + _id + "?id=" + _id)];
                case 1:
                    // Effectuez votre appel Axios pour valider la décision
                    _a.sent();
                    updatedDemandes = demandesConge.map(function (demande) {
                        if (demande._id === _id) {
                            return __assign(__assign({}, demande), { statut: 'Refusée En attente de confirmation' }); // Mettre à jour le statut de la demande
                        }
                        return demande;
                    });
                    setDemandesConge(updatedDemandes); // Met à jour l'état avec les nouvelles données

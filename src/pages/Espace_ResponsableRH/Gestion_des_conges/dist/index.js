...
var Gestion_Cong__Rh_1 = require("src/views/Gestion-Cong\u00E9/Gestion_Cong\u00E9_Rh");
...
var GestionConges = function () {
    // ** State
    var _a = react_1.useState('GestionDesCongésRh'), value = _a[0], setValue = _a[1];
    ...
    return (React.createElement(Card_1["default"], null,
        React.createElement(TabContext_1["default"], { value: value },
            React.createElement(TabList_1["default"], { onChange: handleChange, "aria-label": 'account-settings tabs', sx: { borderBottom: function (theme) { return "1px solid " + theme.palette.divider; } } },
                React.createElement(Tab, { value: 'GestionDesCong\u00E9sRh', label: React.createElement(Box_1["default"], { sx: { display: 'flex', alignItems: 'center' } },
                        React.createElement(AccountOutline_1["default"], null),
                        React.createElement(TabName, null, "Demandes de cong\u00E9s accept\u00E9es")) }),
                React.createElement(Tab, { value: 'Liste', label: React.createElement(Box_1["default"], { sx: { display: 'flex', alignItems: 'center' } },
                        ...
                        React.createElement(TabName, null, "Traitement Conge")) }),
            ...
            React.createElement(TabPanel_1["default"], { sx: { p: 0 }, value: 'GestionDesCong\u00E9sRh' },
                React.createElement(Gestion_Cong__Rh_1["default"], null)),

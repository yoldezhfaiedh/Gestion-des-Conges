...
import { mdiFileDocumentRemove, mdiMessageBadgeOutline, mdiMessagePlusOutline } from '@mdi/js'
...
const navigation = (): VerticalNavItemsType => {
  return [
  {
...

    {
      ...
      path: '/Espace_ResponsableRH/Profil',
      openInNewTab: false

    },    {
      title: 'Renseignements',
      icon: AccountDetailsOutline,
      path: '/Espace_ResponsableRH/AutresInformations',
      openInNewTab: false
    ...
    },
    {
      ...
      path: '/Espace_ResponsableRH/Demande_conge ',
      openInNewTab: false
    ...
    // },
    {
...

     {
      ...
      path: '/Espace_ResponsableRH/Gestion_des_conges',
      openInNewTab: false
    },
    {
      title: 'Gérer les Utilisateurs',
      icon: AccountEditOutline,
      path: '/Espace_ResponsableRH/Gestion_des_utilisateurs',
      openInNewTab: false
    ...
    },
    {
      ...
      path: '/Espace_ResponsableRH/Gestion_comptes_employe',
      openInNewTab: false
    ...
    },
    {
      ...
      icon: Update,
      path: '/Espace_ResponsableRH/Gestion_Presence',
      openInNewTab: false
    },
    {title: 'Réviser les soldes',
      icon: DeleteSweep,
      path: '/Espace_ResponsableRH/GestionDeLasaisie',
      openInNewTab: false
    },
    {
      title: 'Gérer les Départements',
      icon: TextBoxPlusOutline,
      path: '/Espace_ResponsableRH/Gestion_Departement',
      openInNewTab: false
    ...
    },
    {
      title: 'Type de Congé',
      icon: TextBoxPlusOutline,
      path: '/Espace_ResponsableRH/Gestion_type_conge',
      openInNewTab: false
    },
    {
...

    {
      ...
      path: '/Espace_ResponsableRH/LancerConversation',
      openInNewTab: false

    },    {
      title: 'Discussions',
      icon: MessageBadgeOutline,
      path: '/Espace_ResponsableRH/messagerie',
      openInNewTab: false
